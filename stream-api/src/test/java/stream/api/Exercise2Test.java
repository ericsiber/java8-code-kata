...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void top3RichCustomer() {
         ...
         */
        Comparator<Customer> comparator = Comparator.comparingInt(Customer::getBudget).reversed();
        Stream<String> top3RichCustomerStream = customerList.stream().sorted(comparator).limit(3).map(Customer::getName);
